...
export const DRIVERS: { [index: number]: Driver } = {
  ...
  34: { abbreviation: 'KAU', firstName: 'Lars', lastName: 'Kaufmann' },
  ...
  129: { abbreviation: 'HUG', firstName: 'Jake', lastName: 'Hughes' },
  130: { abbreviation: 'VES', firstName: 'Frederik', lastName: 'Vesti' },
  ...
  143: { abbreviation: 'HAK', firstName: 'Mika', lastName: 'Häkkinen' },
  ...
  150: { abbreviation: 'LEC', firstName: 'Arthur', lastName: 'Leclerc' },
  ...
  160: { abbreviation: 'ARO', firstName: 'Paul', lastName: 'Aron' },
  161: { abbreviation: 'BOR', firstName: 'Gabriel', lastName: 'Bortoleto' },
  162: { abbreviation: 'COL', firstName: 'Franco', lastName: 'Colapinto' },
  163: { abbreviation: 'TBA', firstName: 'Taylor', lastName: 'Barnard' },
  164: { abbreviation: 'DUE', firstName: 'Joshua', lastName: 'Duerksen' },
